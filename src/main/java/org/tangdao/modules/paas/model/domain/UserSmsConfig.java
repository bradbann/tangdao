...
public class UserSmsConfig extends DataEntity<UserSmsConfig> {
	...
	private String signatureSource;		// 签名途径，0：自维护，1：系统强制
	private String signatureContent;		// 签名内容
	private String extNumber;		// 扩展号码
	private String submitInterval;		// 短信提交时间间隔（同一号码）
	private String limitTimes;		// 短信每天提交次数上限（同一号码）
