package org.tangdao.modules.paas.async;
...
public class AsyncService {
    ...
    public void publishMobilesLocalToRedis() {
        ...
        stringRedisTemplate.execute((connection)  -> {
                ...
                byte[] key = serializer.serialize(PaasRedisConstant.RED_AREA_MOBILES_LOCAL);

                byte[] value = JSON.toJSONBytes(PaasRedisConstant.GLOBAL_MOBILES_LOCAL);
