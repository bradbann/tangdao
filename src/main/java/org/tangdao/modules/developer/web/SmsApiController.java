...
import org.tangdao.modules.developer.prervice.SmsPrervice;
...
import org.tangdao.modules.developer.response.sms.SmsBalanceResponse;
import org.tangdao.modules.developer.response.sms.SmsSendResponse;
import org.tangdao.modules.developer.validator.sms.SmsP2PTemplateValidator;
import org.tangdao.modules.developer.validator.sms.SmsP2PValidator;
import org.tangdao.modules.developer.validator.sms.SmsValidator;
...
@Api(value = "开心生活平台--短信服务", tags = "开心生活平台--短信服务")
public class SmsApiController extends BasicApiSupport {
     ...
     * @return
     */
    @ApiOperation(value = "单条/批量短信发送", notes = "单条/批量短信发送!!!", tags = { "kaixinsh.sms.v1" }, httpMethod = "POST")
    @ApiImplicitParams({
