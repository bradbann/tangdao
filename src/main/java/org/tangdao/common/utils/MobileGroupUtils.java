 ...
 */
public class MobileGroupUtils {

	private static Logger logger = LoggerFactory.getLogger(MobileGroupUtils.class);
	// 数据分隔符
	 ...
	 * @return
	 */
	public static MobileGroup doGroup(String mobileNumber) {
		...
		MobileGroup response = new MobileGroup();
		try {
	 ...
	 * @return
	 */
	public static MobileGroup doGroup(List<String> mobiles) {
	...
	public static class MobileGroup implements Serializable {
		...
		public String toString() {
			return "MobileGroup [处理结果=" + success + ", 移动号码数=" + cmSize
