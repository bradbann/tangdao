package org.tangdao.config.rabbit.listener;
...
import org.tangdao.config.rabbit.AbstartRabbitListener;
...
import org.tangdao.modules.exchanger.config.OpenApiCode.SmsPushCode;
...
import org.tangdao.modules.sms.config.PassageContext.PassageSignMode;
import org.tangdao.modules.sms.config.PassageContext.PassageSmsTemplateParam;
import org.tangdao.modules.sms.config.TaskContext.MessageSubmitStatus;
import org.tangdao.modules.sms.config.TaskContext.PacketsApproveStatus;
...
import org.tangdao.modules.sms.service.impl.SmsPassageMessageTemplateServiceImpl;
...
//    private ThreadPoolTaskExecutor            threadPoolTaskExecutor;
    ...
    private void transport2Gateway(SmsMtTaskPackets packets) {
        ...
        // 查询推送地址信息
        PushConfig pushConfig = pushConfigService.getPushUrl(packets.getUserCode(), CallbackUrlType.SMS_STATUS.getCode(),
                                                             packets.getCallback());
