        ...
        var dataGrid = typeof $this != "undefined" ? $this : options.dataGrid ? options.dataGrid : $("#dataGrid")
          ...
          , options = $.extend({
            ...
            loadComplete: function(data) {
                ...
                //滚动条设置
                // new PerfectScrollbar('.ui-jqgrid-bdiv', {
            ...
            searchForm.submit(function() {
                ...
                setTimeout(function() {
                    ...
                    if ($.fn.select2 !== undefined) {
                        searchForm.find("select.select2:not(.noselect2)").trigger("change")
                    }
...
function pageHtml(c) {
    ...
    var b = ['<div class="d-flex mt-2"><ul class="pagination pagination-filled mb-0">\n']
      , a = 0;
    if (c.pageNo == c.first) {
        b.push('<li class="page-item disabled"><a href="javascript:;" class="page-link page-link-icon"><i class="fa fa-angle-left"></i></a></li>\n')
    } else {
        b.push('<li class="page-item"><a href="javascript:;" class="page-link page-link-icon" onclick="' + c.funcName + "(" + c.prev + "," + c.pageSize + ",'" + c.funcParam + '\');"> <i class="fa fa-angle-left"></i></a></li>\n')
    }
    ...
    for (a = c.centerBegin; a <= c.centerEnd; a++) {
        if (a == c.pageNo) {
            b.push('<li class="page-item active"><a href="javascript:;" class="page-link">' + (a + 1 - c.first) + "</a></li>\n")
        } else {
            b.push('<li class="page-item"><a href="javascript:;" class="page-link" onclick="' + c.funcName + "(" + a + "," + c.pageSize + ",'" + c.funcParam + "');\">" + (a + 1 - c.first) + "</a></li>\n")
        }
    }
    ...
    if (c.pageNo == c.last) {
        b.push('<li class="page-item disabled"><a href="javascript:;" class="page-link page-link-icon"><i class="fa fa-angle-right"></i></a></li>\n')
    } else {
        b.push('<li class="page-item"><a href="javascript:;" class="page-link page-link-icon" onclick="' + c.funcName + "(" + c.next + "," + c.pageSize + ",'" + c.funcParam + '\');"><i class="fa fa-angle-right"></i></a></li>\n')
    }
    b.push("</ul>\n");
...
function pageHtmlControl(b) {
    var a = ['<div class="mg-l-auto align-self-center d-sm-none d-md-block">\n'];
    a.push('<div class="pagination_pager-detail" title="' + $.jgrid.extend.pageTitle + '">' + $.jgrid.extend.pageLabelA + " ");
    ...
    a.push((b.pageInfo && b.pageInfo != "" ? b.pageInfo : "") + "</div>\n");
    a.push("</div>\n");
    return a.join("")
}
(function(a) {
