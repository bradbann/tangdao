...
//					ajaxParams.data = JSON.stringify($.extend({}, ajaxParams.data,  data, Plugin.getOption('data.source.read.params')));
					ajaxParams.data = $.extend({}, ajaxParams.data, data.pagination, data.sort, Plugin.getOption('data.source.read.params'));
